...
### 2.3. Caso de uso **REGISTRAR CHAMADO**
...
### 2.4. Caso de uso **Filtrar Crimes Ocorridos no Newsletter**
...
| 3) O sistema apresenta as informações da hora, local e tipo de crime em um rank com no máximo 10 posições. |
